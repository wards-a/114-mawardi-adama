            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    <a href="#" class="flex ms-2 md:me-24">
                        ...
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Goodiebagcustom</span>
                    </a>
                </div>
            </div>
        </div>
    </nav>
    <main class="dark:bg-slate-900 h-screen">
        <form action="{{ route('signin.auth') }}" method="POST" class="absolute left-1/3 top-48 w-1/3">
            @csrf
            <div class="mb-5">
