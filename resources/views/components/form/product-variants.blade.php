...
<div {{ $attributes }}>
    <div class="relative flex border border-gray-300 dark:border-gray-600 sm:rounded-lg">
        ...
        <div class="btn-repeater-delete flex items-center border-l border-l-gray-300 dark:border-l-gray-600 px-0.5 hover:cursor-pointer">
