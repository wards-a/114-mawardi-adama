        ...
        <div id="contact-form-container">
            <form id="formLogin" action="{{ route('login.auth') }}" method="POST" class="space-y-8 mb-5">
                ...
                <div class="relative input">
                    ...
                    <input type="text" name="email" id="email" class="w-full ps-0 border-0 border-b border-slate-400 text-sm py-1 transition-colors duration-300 focus:ring-0 focus:outline-0 focus:border-b-2 focus:border-b-sky-700">
                    @error('email')
                ...
                <div class="relative input">
                    ...
                    <input type="password" name="password" id="password" class="w-full ps-0 border-0 border-b border-slate-400 text-sm py-1 transition-colors duration-300 focus:ring-0 focus:outline-0 focus:border-b-2 focus:border-b-sky-700">
                    @error('password')
                    <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                        {{ $message }}
                    </p>
                ...
                <div class="flex flex-col justify-center gap-y-5 text-center text-sm">
                    <a href="{{ route('forgot-password') }}" class="underline text-sky-700 active:text-sky-700">Lupa kata sandi?</a>
