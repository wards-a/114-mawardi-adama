        ...
        <div id="contact-form-container">
            <form id="formRegistration" action="" method="post" class="space-y-8 mb-5"> {{-- route('user.contact.send') --}}
                ...
                <div class="relative input">
                    ...
                    <input type="name" name="name" id="name" class="w-full border-b border-slate-400 text-sm py-1 transition-colors duration-300 focus:outline-0 focus:border-b-2 focus:border-b-sky-700" required>
                </div>
                <div class="relative input">
                ...
                <div class="relative input">
                    ...
                    <input type="password" name="subject" id="subject" class="w-full border-b border-slate-400 text-sm py-1 transition-colors duration-300 focus:outline-0 focus:border-b-2 focus:border-b-sky-700" required>
                </div>
