<section id="highlight-product">
    <div class="w-full max-w-6xl mb-6 pb-2.5 border-b lg:mb-8 lg:mx-auto">
        <div class="flex items-center justify-between w-full mb-3.5 lg:mb-2">
            <h2 class="text-base font-semibold ml-2.5 lg:text-2xl">Rekomendasi Untukmu</h2>
            <a href="#" class="mr-2.5 text-sm font-medium">Lihat Semua</a>
        </div>
        <div class="product-carousel mb-5 pl-2.5">
            <div class="slick-slide w-full h-80 max-w-44 mx-1 pl-2.5">
                <a href="#" class="block h-72 max-w-40 shadow-lg rounded-lg">
                    ...
                    <div class="flex flex-col p-2.5">
                        ...
                        <div>
                            <p class="text-blue-700 font-semibold mb-1">Rp 15.000</p>
            ...
            <div class="slick-slide w-full h-80 max-w-44 mx-1 pl-2.5">
                <a href="#" class="block h-72 max-w-40 shadow-lg rounded-lg">
                    ...
                    <div class="flex flex-col p-2.5">
                        <p class="text-sm overflow-hidden text-ellipsis">Blacu Putih Polyster</p>
                        <div>
                            <p class="text-blue-700 font-semibold mb-1">Rp 7.000</p>
