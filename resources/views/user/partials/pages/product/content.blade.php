<section class="w-full mt-3 clear-both">
    <div class="w-full px-5 md:px-16">
        <div class="w-full px-3.5 mb-5 lg:mb-8 lg:px-0">
            <h1 class="text-lg lg:text-xl">Rekomendasi Untukmu</h1>
    ...
    <div class="flex justify-between w-11/12 mb-5 mx-auto px-4">
        <div class="w-3/5 text-sm text-slate-600">
            <p>Menampilkan 1-10 dari 10 produk</p>
        </div>
