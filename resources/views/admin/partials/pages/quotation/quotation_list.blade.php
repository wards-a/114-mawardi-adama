...
<x-caption title="Daftar Quotation" class="my-5" />
...
<div class="shadow-md sm:rounded-lg">
    <div
        ...
        <div class="pe-4">
            {{-- <x-add-button title="Buat Quotation" link="{{ route('product.create') }}" class="p-4" /> --}}
        </div>
    </div>
    <x-table.table-content class="relative overflow-x-auto" :collection="[$quotations]" :theads="$table_heads" :tactions="$table_actions" />
</div>
<x-delete-modal />
