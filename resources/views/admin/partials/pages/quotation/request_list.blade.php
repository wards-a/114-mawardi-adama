...
<x-caption title="Daftar Permintaan" class="my-5" />
...
<div class="shadow-md sm:rounded-lg">
    ...
    <x-table.table-content class="relative overflow-x-auto" :collection="[$orders]" :theads="$table_heads" :tactions="$table_actions" />
</div>
<x-delete-modal />
