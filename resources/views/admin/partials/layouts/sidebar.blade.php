        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <button type="button"
                    ...
                    aria-controls="dropdown-quotations" data-collapse-toggle="dropdown-quotations">
                    ...
                    <div class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">
                        <span>Quotations</span>
                        <span
                            class="inline-flex items-center justify-center w-3 h-3 p-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">3</span>
                    </div>
            ...
            <li>
                <div class="border-b border-gray-400 dark:border-slate-700"></div>
            </li>
            <li>
                <a href="/product"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="{{ route('category.index') }}"
                    ...
                    <x-svg
                        ...
                        fill="currentColor">
                        <use xlink:href="/icons.svg#icon-tag" />
                    </x-svg>
            ...
            <li>
                <a href="{{ route('flag.index') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Flag</span>
                </a>
            </li>
        </ul>
        <div id="copyright" class="relative top-32">
            <p class="text-xs text-gray-900 dark:text-white">&#169; 2024 PT. Goodiebag Custom Indonesia</p>
        </div>
    </div>
</aside>
