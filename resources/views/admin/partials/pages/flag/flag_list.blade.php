{{-- {{ dd($flags) }} --}}
<x-caption title="Daftar Penanda" class="my-5" />
...
<div class="shadow-md sm:rounded-lg">
    <div
        ...
        <div class="pe-4">
            <x-add-button title="Tambah Flag" link="{{ route('flag.create') }}" class="p-4" />
        </div>
    </div>
    <x-table.table-content class="relative overflow-x-auto" :collection="[$flags]" :theads="$table_heads" :tactions="$table_actions" />
</div>
<x-delete-modal />
