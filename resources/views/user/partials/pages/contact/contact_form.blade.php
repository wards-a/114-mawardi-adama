<section id="contact-us-formulir" class="min-h-screen">
            ...
            <div id="contact-form-container" class="md:basis-9/12 md:pr-14 md:border-r md:border-slate-500">
                <form id="formContactUs" action="{{ route('send-mail') }}" method="post" class="space-y-8">
                    ...
                    <fieldset class="relative input">
                        ...
                        <input type="text" name="name" id="name" class="w-full ps-0 border-0 border-b border-slate-400 text-sm py-1 transition-colors duration-300 focus:ring-0 focus:outline-0 focus:border-b-2 focus:border-b-sky-700" required>
                    </fieldset>
                    <fieldset class="relative input">
                        ...
                        <input type="email" name="email_user" id="email_user" class="w-full ps-0 border-0 border-b border-slate-400 text-sm py-1 transition-colors duration-300 focus:ring-0 focus:outline-0 focus:border-b-2 focus:border-b-sky-700" required>
                    </fieldset>
                    <fieldset class="relative input">
                        ...
                        <input type="text" name="subject" id="subject" class="w-full ps-0 border-0 border-b border-slate-400 text-sm py-1 transition-colors duration-300 focus:ring-0 focus:outline-0 focus:border-b-2 focus:border-b-sky-700" required>
                    </fieldset>
                    <fieldset class="relative input">
                        ...
                        <textarea name="message" id="message" class="w-full ps-0 border-0 border-b border-slate-400 text-sm py-1 transition-colors duration-300 focus:ring-0 focus:outline-0 focus:border-b-2 focus:border-b-sky-700" rows="5" required></textarea>
                    </fieldset>
